...
const loadUserData = () => {
  ...
  const userAuth = appStorage.user_auth; // Retrieve user authentication info
  userName.value = userAuth.full_name || 'Unknown User';
  userEmail.value = userAuth.email || 'No Email Provided';
  userProfilePic.value = userAuth.profilePic || userProfilePic.value;
};
