<script setup>
import accData from '@/acc.json';  // Import the acc.json file
import { ref, computed } from 'vue';

// Reactive reference for the data
const items = ref(accData);
  ...
  <div>
    ...
    <div id="searchContainer">
      <input 
        v-model="searchQuery" 
        type="text" 
        placeholder="🔍 Type the name or email and we will look for it..."
      />
    </div>
        ...
        <thead>
          <tr>
            ...
            <th @click="sortTable('email')">
              Email <span :class="getSortIcon('email')"></span>
            </th>
